  ...
  return (
    <div className="container">
      <div className="calculator-grid">
        ...
        <button onClick={() => dispatch({ type: ACTIONS.DELETE_DIDIT })}>
          DEL
        </button>
        <OperationButton
          operation="/"
          dispatch={dispatch}
          icon={<FontAwesomeIcon icon="fa-solid fa-divide" />}
        />
        ...
        <OperationButton
          operation="*"
          dispatch={dispatch}
          icon={<FontAwesomeIcon icon="fa-solid fa-multiply" />}
        />
        ...
        <OperationButton
          operation="-"
          dispatch={dispatch}
          icon={<FontAwesomeIcon icon="fa-solid fa-subtract" />}
        />
